		...
		btn1.addActionListener(
				new ActionListener(){
					public void actionPerformed(ActionEvent event){
						try {
							BufferedWriter bw = new BufferedWriter(new FileWriter("I:\\java提出のメモ\\商品表サンプル.txt"));
							//bw.flush();   //?
		...
		btn2.addActionListener(
				new ActionListener(){
					public void actionPerformed(ActionEvent event){
						try{
							text1.setText("");
							BufferedReader br = new BufferedReader(new FileReader("I:\\java提出のメモ\\商品表サンプル.txt"));  // ファイルを開く
							String line;
